...
Color.prototype.setRGB = function( r, g, b ) { // null = don't change
...
Color.prototype.setHSV = function( h, s, v ) { // null = don't change
...
Color.prototype.RGB_HSV = function( r, g, b ) {
...
Color.prototype.HSV_RGB = function( h, s, v ) {
    if ( h == null )
    {
        return [ v, v, v ];
    }
...
Color.prototype.toHSVArray = function() {
